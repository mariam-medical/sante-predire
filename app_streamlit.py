...
# ==================== PAGE TABLEAU DE BORD ====================
    ...
    with col4:
        st.metric("🥼 Médecins", len(st.session_state.medecins))
...
elif menu == "🥼 Gestion des médecins":
    st.markdown('<p class="main-title">🥼 Gestion des médecins</p>', unsafe_allow_html=True)
